...
export function scrollViewportToShowTarget(
	{ target, viewportOffset = 0 }: { target: HTMLElement | Range, viewportOffset?: number}
): void {
...
function scrollWindowToShowRect( window: Window, rect: Rect, viewportOffset: number ) {
...
function scrollAncestorsToShowRect( parent: HTMLElement, getRect: () => Rect ) {
