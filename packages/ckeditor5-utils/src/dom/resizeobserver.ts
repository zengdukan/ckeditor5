...
export default class ResizeObserver {
	...
	static _observerInstance: Observer | null;
	static _elementCallbacks: Map<HTMLElement, Set<Callback>> | null;
	 ...
	 */
	static _addElementCallback( element: HTMLElement, callback: Callback ) {
	 ...
	 * @param {Function} callback
	 */
	static _deleteElementCallback( element: HTMLElement, callback: Callback ) {
	 ...
	 */
	static _getElementCallbacks( element: HTMLElement ): Set<Callback> | null {
		if ( !ResizeObserver._elementCallbacks ) {
			return null;
		}
...
class ResizeObserverPolyfill {
	private readonly _callback: PolyfillCallback;
	 ...
	 * learn more.
	 */
	constructor( callback: PolyfillCallback ) {
		/**
	 ...
	 * @returns {Boolean}
	 */
	_hasRectChanged( element: HTMLElement ) {
...
type Callback = ( entries: { target: HTMLElement, contentRect: RectLike } ) => void;
type PolyfillCallback = ( entries: { target: HTMLElement, contentRect: RectLike }[] ) => void;
