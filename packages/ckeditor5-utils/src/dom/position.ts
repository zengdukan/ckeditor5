...
export function getOptimalPosition( { element, target, positions, limiter, fitInViewport, viewportOffsetConfig }: Options ): Position {
	...
	const positionOptions: PositionOptions = { targetRect, elementRect, positionedElementAncestor };
...
export class Position {
	 ...
	 */
	constructor( positioningFunction: PositioningFunction, options: PositionOptions ) {
