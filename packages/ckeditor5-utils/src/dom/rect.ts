...
function copyRectProperties( rect: Rect, source: RectLike ) {
...
// @returns {Boolean}
function isBody( elementOrRange: RectSource | Node ): elementOrRange is HTMLBodyElement {
	if ( !isDomElement( elementOrRange ) ) {
		return false;
	}
